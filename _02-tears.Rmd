...
* [Answers to Tabel 2 with data read in with `sjlabelled::read_stata()`](\#tab:sjlabelled-see-labels)
* [Answers to Tabel 2 with data read in with `readstata13::read.dta13()`](\#tab:readstata13-see-labels)
...
| `readstata13` |  N/A             | ERROR               | FALSE             |
+---------------+------------------+---------------------+-------------------+
Table: (\#tab:sjlabelled-see-labels) [Table 2](\#tab:labels-table) filled in with data read in from `sjlabelled::read_stata()`
...
```{r sjlabelled-loaded-labels-readstata13}
...
With that, we can fill out our final iteration of [Table 2](\#tab:labels-table).
...
+---------------+--------------+---------------------+-------------------+
Table: (\#tab:readstata13-see-labels) [Table 2](\#tab:labels-table) filled in with data read in from `readstata13::read.dta13()`
